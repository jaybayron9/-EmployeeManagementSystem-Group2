...
$getActiveEmployee = mysqli_query($web_db, "SELECT * from employee_tbl INNER JOIN department_tbl on department_tbl.department_id = employee_tbl.department_id where employee_status = 'EMPLOYED'");
$leave_btn = "";
